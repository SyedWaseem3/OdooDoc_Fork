...
- :ref:`Icon set <spreadsheet/conditional-formatting/icon-set>`: uses sets of green, orange and red
  arrows, smileys or dots to visually show how cell values in a range compare to certain defined
  values, e.g., a green smiley to represent sales performance above a certain amount.
...
#. Click below :guilabel:`Apply to range`, then, in the spreadsheet, select the range of cells the
...
#. For the first two icons listed, define the conditions to be met for the icon to be shown, e.g.,
   when the value is above a certain percentage.
...
.. example::
   In the example, a green color dot is added to total sales amounts over $50,000, an orange dot is
   added to total sales amounts over $30,000, and a red dot is added to all other amounts.
...
.. note::
   ...
   corresponding range of cells, e.g., on an column containing text. The :guilabel:`Apply to range`
